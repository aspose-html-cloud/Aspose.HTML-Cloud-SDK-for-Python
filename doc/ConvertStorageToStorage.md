...
try:
    res = html_api.convert_storage_to_storage(input_file="test.html", output_file="test.jpg",
                                                         storage_name=None)
...
try:
    res = html_api.convert_storage_to_storage(input_file="test.html", output_file="test.jpeg",
